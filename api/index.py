...
def fetch_info(uid, region="ind"):
    try:
        ...
        if r.status_code != 200:
            return None, "Info API HTTP " + str(r.status_code)
        return extract_info(r.json()), None
    except Exception as e:
        return None, "Info error: " + str(e)[:60]
...
def fetch_ban(uid):
    try:
        ...
        if r.status_code != 200:
            return None, None, "Ban API HTTP " + str(r.status_code)
        ...
        return None, None, "Ban error: " + str(e)[:60]
